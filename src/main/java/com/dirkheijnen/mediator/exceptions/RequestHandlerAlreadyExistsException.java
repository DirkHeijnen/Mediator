...
/**
 *  The {@link RequestHandlerAlreadyExistsException} is thrown when an {@link IRequestHandler} already exists for
 *  a given {@link IRequest}.
 *
 *  @author Dirk Heijnen
 *  @since 1.0
 */
public class RequestHandlerAlreadyExistsException extends RuntimeException {

    /**
     *  Default exception handler without message.
     */
    public RequestHandlerAlreadyExistsException(){
        super();
    }
